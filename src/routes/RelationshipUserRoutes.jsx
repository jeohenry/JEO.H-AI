...
const RelationshipUserRoutes = () => (
  <>
    ...
    <Route path="translated-feed" element={<PageWrapper animation={slideUp}><TranslatedFeed /></PageWrapper>} />
    ...
    <Route path="tools" element={<PageWrapper animation={scaleFade}><RelationshipTools /></PageWrapper>} />
    <Route path="group-video-call" element={<PageWrapper animation={slideUp}><GroupVideoCall /></PageWrapper>} />
    <Route path="live-video-chat" element={<PageWrapper animation={slideRight}><LiveVideoChat /></PageWrapper>} />
